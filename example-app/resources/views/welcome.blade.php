...
<body bgcolor="#EEB4B4">
    ...
    <h1 >🕹️ ตารางแม่สูตรคูณ 🧮</h1>
    <button onclick="alert('Say Hi')" >❌ Don't Click Me ❌</button>
    <input type="text" id="my_number" value="15">
    ...
    <style>
        body{text-align:center; margin:0 auto; margin-top:2cm; color: rgb(117, 72, 72); }
